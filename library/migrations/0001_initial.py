# Generated by Django 4.0.1 on 2023-03-05 11:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_creation', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('date_of_editing', models.DateTimeField(auto_now=True, verbose_name='Дата редактирования')),
                ('active_books', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='library.books', verbose_name='Активные книги')),
            ],
            options={
